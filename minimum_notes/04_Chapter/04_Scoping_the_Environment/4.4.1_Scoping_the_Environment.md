...
elseif(CMAKE_CXX_BYTE_ORDER STREQUAL "BIG_ENDIAN")
    ...
    message(WARNING "CMake could not determine the byte order.")
endif()
```
In most cases, **endianness** doesn't matter, except for when you are writing bit wise code. CMake will provide you with BIG_ENDIAN or LITTLE_ENDIAN value stored in the CMAKE_\<LANG\>_BYTE_ORDER variable, where \<LANG\> is C, CXX, OBJC, or CUDA.